...
{
	/* Sets the frequency of a channel in the config.channel array and upadtes the mask of configured channels */
...
{
	/* Loads a default configuration in the handle.config  */
...
{
	/* Resets the RFM95 using its RESET pinn (not connected on our schematic)
	   Section 7.2.2 in the datasheet */
...
{
	/* Initializes the RFM95 chip */

	// Check if the handle was intialized
	// May be better to set the fields of the handle here
